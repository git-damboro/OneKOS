...
export const implementationGuides = {
  ...
  profile: {
    title: '动态顾问画像', simulated: '模拟解析 18 条历史内容、60 秒语音和 6 组偏好选择。',
    sources: '正式版只读取顾问主动填写或授权的数据，并记录每条标签证据。', components: '飞书表单/卡片、妙记或语音转写、多维表格、Aily 记忆。',
    processing: '显式资料形成初值，采用、修改、拒绝、内容表现和线索结果持续更新权重。', boundary: '标签可删除、降低或锁定；不推断敏感属性，可撤回授权。',
  },
  topics: {
    title: '机会雷达与一题千解', simulated: '品牌任务、评论需求、趋势热度和矩阵空白均为模拟输入。',
    sources: '正式版来自总部任务、知识库、获授权评论、平台公开趋势及区域运营配置。', components: '多维表格视图、定时工作流、Aily 技能编排。',
    processing: '先过滤事实和权限，再按画像匹配、需求热度、矩阵空白和线索价值排序。', boundary: '推荐只给 1—3 个任务，顾问可拒绝；拒绝本身成为学习信号。',
  },
  studio: {
